...
class Beasiswa extends Model
{
    ...
    protected $fillable = ['nama', 'deskripsi', 'biaya_hidup', 'biaya_pendidikan', 'ipk_minimal', 'penghasilan_orang_tua_maksimal', 'nilai_sma', 'prestasi', 'sikap', 'organisasi', 'awal_pendaftaran', 'akhir_pendaftaran', 'awal_penerimaan', 'akhir_penerimaan', 'bobot_ipk', 'bobot_prestasi', 'bobot_perilaku', 'bobot_organisasi', 'bobot_kemampuan_ekonomi'];
